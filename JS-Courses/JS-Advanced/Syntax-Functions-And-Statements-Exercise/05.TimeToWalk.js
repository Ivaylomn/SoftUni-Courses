function timeToWalk(stepToUniversitety, footprint, speedInKilometers){
    let distanceInM = stepToUniversitety * footprint;
    let distanceInKm = distanceInM / 1000;
    let timeInMinutes = (distanceInKm / speedInKilometers) * 60;
